/*
  # Fix get_admin_analytics: replace total_cents with subtotal_cents + tax_cents

  The orders table does not have a total_cents column. Revenue is correctly
  computed as subtotal_cents + tax_cents. This migration drops and recreates
  the parameterized get_admin_analytics function with the correct column references.
*/
