/*
  # Fix get_admin_analytics: tip_cents is on orders, not payments

  The payments table does not have a tip_cents column. Tips are stored on the
  orders table as tip_cents. This migration fixes the total_tips_cents and
  orders_with_tips aggregations accordingly.
*/
