...
export function OrderSummary({
  ...
  return (
    <div className={`bg-white rounded-lg border border-slate-200 print-summary-container ${className}`}>
        ...
        <div className="p-6 space-y-4 print-summary-content">
        ...
        <div className="pt-3 border-t border-slate-200 space-y-2">
          <div className={`flex justify-between ${hasChanged('subtotal') ? 'bg-blue-50 -mx-2 px-2 py-1 rounded print-highlight' : ''}`}>
          ...
          {summary.customFees.map((fee, index) => (
            <div key={index} className="flex justify-between">
              <span className="text-slate-700 flex items-center gap-2">
                {fee.name}
                <span className="bg-blue-100 text-blue-700 text-xs px-2 py-0.5 rounded-full font-semibold print-badge">ADDED</span>
              </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-700 font-bold text-base">
                  ...
                  {customDepositCents !== null && customDepositCents !== undefined && customDepositCents !== summary.depositDue && (
                    <span className="ml-1 text-xs bg-amber-600 text-white px-1 py-0.5 rounded print-badge">OVERRIDE</span>
                  )}
                </span>
              </div>
            </div>
        ...
        {summary.isMultiDay && (
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg print-item">
