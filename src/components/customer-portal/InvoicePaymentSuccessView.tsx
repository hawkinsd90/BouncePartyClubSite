...
interface InvoicePaymentSuccessViewProps {
  orderId: string;
}

export function InvoicePaymentSuccessView({ orderId }: InvoicePaymentSuccessViewProps) {
  return (
      ...
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-2xl overflow-hidden border-4 border-green-500">
        ...
        <div className="px-8 py-8 text-center">
          <p className="text-lg text-slate-700 mb-6">
            Thank you for your payment on order{' '}
            <strong>#{formatOrderId(orderId)}</strong>. Your booking is now confirmed!
          </p>
          ...
          <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 mb-6 text-left">
            ...
            <ul className="text-blue-800 space-y-2 text-sm">
              <li>• Your booking is confirmed and we're preparing for your event</li>
              <li>• You'll receive a confirmation email with the booking details</li>
              <li>• We'll be in touch closer to your event date with final details</li>
