...
const statusConfigs: Record<OrderStatus, StatusConfig> = {
  ...
  [ORDER_STATUS.SETUP_IN_PROGRESS]: { label: ORDER_STATUS_LABELS[ORDER_STATUS.SETUP_IN_PROGRESS], className: 'bg-purple-100 text-purple-700', icon: Clock },
  [ORDER_STATUS.ON_THE_WAY]: { label: ORDER_STATUS_LABELS[ORDER_STATUS.ON_THE_WAY], className: 'bg-blue-100 text-blue-700', icon: Clock },
  [ORDER_STATUS.SETUP_COMPLETED]: { label: ORDER_STATUS_LABELS[ORDER_STATUS.SETUP_COMPLETED], className: 'bg-indigo-100 text-indigo-700', icon: CheckCircle },
  [ORDER_STATUS.PICKUP_IN_PROGRESS]: { label: ORDER_STATUS_LABELS[ORDER_STATUS.PICKUP_IN_PROGRESS], className: 'bg-purple-100 text-purple-700', icon: Clock },
